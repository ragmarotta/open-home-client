...
*   **Atalho de Guia Rápido**: O botão "Não possui as chaves? Siga o guia rápido" abre o portal de desenvolvedores da Tuya (`https://platform.tuya.com/`) diretamente no navegador do dispositivo usando o plugin `url_launcher`.
