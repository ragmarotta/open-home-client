...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'pt': {
      ...
      // Tela Tuya & Gerenciador
      'tuya_integration': 'Integração Tuya Cloud',
      'tuya_creds': 'Credenciais Tuya Cloud',
      'client_id': 'Access ID / Client ID',
      'client_secret': 'Access Secret / Client Secret',
      'region': 'Região / Data Center',
      'disconnected': 'Desconectado',
      'connected': 'Conectado à Nuvem',
      'save_sync': 'Salvar e Sincronizar',
      'sync_devices': 'Sincronizar Dispositivos',
      'disconnect': 'Desconectar',
      'space_manager': 'Gerenciador de Espaços',
      'create_room': 'Criar Novo Cômodo',
      'unassigned_devices': 'Dispositivos Não Atribuídos',
      'assign_to': 'Vincular a...',
      'rename': 'Renomear',
      'room_name': 'Nome do Cômodo',
      'floor': 'Andar',
      'room_created': 'Cômodo criado com sucesso!',
      'device_assigned': 'Dispositivo vinculado!',
    ...
    'en': {
      ...
      // Tuya & Manager Screen
      'tuya_integration': 'Tuya Cloud Integration',
      'tuya_creds': 'Tuya Cloud Credentials',
      'client_id': 'Access ID / Client ID',
      'client_secret': 'Access Secret / Client Secret',
      'region': 'Region / Data Center',
      'disconnected': 'Disconnected',
      'connected': 'Connected to Cloud',
      'save_sync': 'Save and Sync',
      ...
      'device_assigned': 'Device linked successfully!',
